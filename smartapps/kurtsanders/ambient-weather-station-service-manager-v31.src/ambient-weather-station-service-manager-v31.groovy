...
def news() {
    return [
        ...
        "date"    : "2019-01-05",
        "updates" : [
            "Reduced Nested Menu Trees to hopefully accomodate Android install issues",
            "Added a NO COLOR option during install to accomodate Android background color issues",
            "Beta Testing - More Updates to come each week.",
            "Recognizes up to 8  Ambient (WH31B or similar) remote temperature/hyro sensor(s) as new child devices (separate SmartThing devices) for viewing and handling temperature and humidity events",
            "Added lux option to options for Units of Measure for displaying Solar Radiation (Illuminance)"
        ]
    ]
}
...
String appName() 				{ return "Ambient Weather Station Service Manager V3.1" }
...
// ========================================================================================
definition(
    name: 			"Ambient Weather Station Service Manager V31",
    namespace: 		"kurtsanders",
    author: 		"kurt@kurtsanders.com",
    description: 	"Ambient Personal Weather Station Service Manager V31",
    category: 		"My Apps",
...
def optionsPage () {
    ...
    dynamicPage(name: "optionsPage", title: "Ambient Tile Settings", nextPage: lastPageName, uninstall:false, install : !remoteSensorsExist ) {
        ...
        section(hideable: true, hidden: true, "SmartThings IDE Live Logging Levels") {
